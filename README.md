...
**Docker Hub Image (Public Link)**

You can pull the image from Docker Hub using the link below:

# Public Docker Hub URL:

https://hub.docker.com/r/sohamsawant878/basic-linux-commands

# Pull Command

docker pull sohamsawant878/basic-linux-commands:latest

# Run Command

docker run sohamsawant878/basic-linux-commands:latest